...
public class UrnaEletronica {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            String[] candidatos = {"Frederico Kiyoshi", "Gabriel Castro", "Artur Bigao"};
            ...
            while (sistemaAtivo) {
                System.out.println("\n===========================================");
                System.out.println("       SISTEMA VOTAÇÃO URNA - MENU            ");
                System.out.println("===========================================");
                    ...
                    case "2" -> {
                        ...
                        if (user.equals(LOGIN_ADMIN) && pass.equals(SENHA_ADMIN)) {
                            ...
                            while (menuAdmin) {
                                ...
                                System.out.println("2 - Encerrar e mostrar Resultados");
